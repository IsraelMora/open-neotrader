"""
market_breadth.py — Market breadth indicators (ported from market-breadth plugin).

Measures how many assets in an index participate in the index direction.
An index rising while only 10% of its assets rise (breadth divergence) is a fragility signal.
...
Indicators:
  ...
  5. Breadth Thrust (Zweig 1986)
  6. Composite Breadth Score (0-100)

References:
  McClellan, S. & McClellan, T. (1970)
...
def compute_breadth(
    ...
    index_prices: list[float] | None = None,
    new_highs: list[int] | None = None,
    new_lows: list[int] | None = None,
